...
export const USERS = [
  ...
  { id: 'rina', nama: 'Admin', peran: 'admin_kantor', label: 'Admin Kantor', color: 'bg-emerald-100 text-emerald-700', nomor_wa: '08123456002' },
  { id: 'lola', nama: 'Lola', peran: 'sosmed', label: 'Tim Media Sosial', color: 'bg-pink-100 text-pink-700', nomor_wa: '08123456003' },

  // Field tier — PJ Kecamatan
  { id: 'pjkj', nama: 'Ci Enni', peran: 'pj_kecamatan', label: 'PJ · Kebon Jeruk', color: 'bg-indigo-100 text-indigo-700', kecamatan: 'Kebon Jeruk', nomor_wa: '081234560011' },
  { id: 'pjgp', nama: 'Bu Lina', peran: 'pj_kecamatan', label: 'PJ · Grogol Petamburan', color: 'bg-indigo-100 text-indigo-700', kecamatan: 'Grogol Petamburan', nomor_wa: '081234560012' },
  { id: 'pjts', nama: 'Pak Wahyono', peran: 'pj_kecamatan', label: 'PJ · Tamansari', color: 'bg-indigo-100 text-indigo-700', kecamatan: 'Tamansari', nomor_wa: '081234560013' },
  { id: 'pjkb', nama: 'Bu Rita', peran: 'pj_kecamatan', label: 'PJ · Kembangan', color: 'bg-indigo-100 text-indigo-700', kecamatan: 'Kembangan', nomor_wa: '081234560014' },
  { id: 'pjpl', nama: 'Bu Silvi', peran: 'pj_kecamatan', label: 'PJ · Palmerah', color: 'bg-indigo-100 text-indigo-700', kecamatan: 'Palmerah', nomor_wa: '081234560015' },
...
export const OFFICE_TIER = ['owner', 'admin_kantor', 'sosmed', 'super_admin'];
...
export const canSeeSosmed = (peran) => ['owner', 'admin_kantor', 'sosmed', 'super_admin'].includes(peran);
export const canSeePigura = (peran) => ['owner', 'admin_kantor', 'pigura', 'super_admin'].includes(peran);
